...
def invalid_credentials(form,field):
    ...
    if user is None:
        raise ValidationError('Username or  is incorrect')
...
class RegistrationForm(FlaskForm):
    ...
    submit_btn=SubmitField("create",render_kw={'class':'btn btn-primary'})
...
class LoginForm(FlaskForm):
    ...
    submit_btn=SubmitField("login",render_kw={'class':'btn btn-primary'})
